...
- clone-coding
- project
image: "/images/posts/written/preview.jpeg"
---



## 씀 클론코딩
 와플 스튜디오에서 2020년 하반기 Rookies Seminar가 끝나고 진행한 toy-project로 여러 조로 나누어서 실제 서비스를 클론 코딩하는 프로젝트를 진행하였고 우리 조는 글쓰기 어플인 ['씀'](https://play.google.com/store/apps/details?id=com.projectm.ezbrother.ssm)을 클론 코딩하였다. 코드를 포함한 repository는 아래 버튼에서 확인해볼 수 있다.
 <ul class="actions">
...
<p>
    <span class="image fit">
        <img src="{{ "/images/posts/written/rank.png" | absolute_url }}" alt="" />
    </span>
